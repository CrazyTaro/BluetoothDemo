package com.taro.bleservice.entity;
            ...
            if (items != null) {
                ...
                switch (typeGroup) {
                    ...
                    case BluetoothHelper.TYPE_GROUP_0D:
                        ...
                        if (oldMax < mCacheMaxs[0]) {
                            mMaxValues.put(BluetoothHelper.TYPE_DATA_GYR, mCacheMaxs[0]);
                        }
                        oldMax = mMaxValues.get(BluetoothHelper.TYPE_DATA_EUL);
                        if (oldMax < mCacheMaxs[1]) {
                            mMaxValues.put(BluetoothHelper.TYPE_DATA_EUL, mCacheMaxs[1]);
                        }
                        break;
                    ...
                    case BluetoothHelper.TYPE_GROUP_0F:
                        ...
                        if (oldMax < mCacheMaxs[0]) {
                            mMaxValues.put(BluetoothHelper.TYPE_DATA_LIA, mCacheMaxs[0]);
                        }
                        oldMax = mMaxValues.get(BluetoothHelper.TYPE_DATA_GRV);
                        if (oldMax < mCacheMaxs[1]) {
                            mMaxValues.put(BluetoothHelper.TYPE_DATA_GRV, mCacheMaxs[1]);
                        }
                        break;
