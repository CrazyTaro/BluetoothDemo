...
public class BleBluetooth {
    ...
    private ArrayMap<String, BluetoothGatt> mGattMap;
    ...
    public void closeBluetoothGatt(String addr) {
        BluetoothGatt gatt = mGattMap.get(addr);
        if (gatt != null) {
            gatt.disconnect();
            refreshDeviceCache();
            gatt.close();
